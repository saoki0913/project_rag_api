...
def create_project_index(project_name:str, spo_url:str):
    ...
    try:
        ...
        fields = [
            ...
            SearchableField(name="documentName", type=SearchFieldDataType.String,  stored=True, searchable=True),
            SearchableField(name="documentPath", type=SearchFieldDataType.String, stored=True, searchable=True),
            SearchableField(name="documentUrl", type=SearchFieldDataType.String, stored=True, searchable=True),
